$ ->
    ...
    __appFirstRotationTimeline
        .append TweenMax.to __tweens['app-first-third'].target, __tweens['app-first-third'].duration, __tweens['app-first-third'].to
        .append TweenMax.to __tweens['app-first-fourth'].target, __tweens['app-first-fourth'].duration, __tweens['app-first-fourth'].to
        .append TweenMax.to __tweens['app-first-fifth'].target, __tweens['app-first-fifth'].duration, __tweens['app-first-fifth'].to
    ...
    __appSecondRotationTimeline
        .append TweenMax.to __tweens['app-second-third'].target, __tweens['app-second-third'].duration, __tweens['app-second-third'].to
        .append TweenMax.to __tweens['app-second-fourth'].target, __tweens['app-second-fourth'].duration, __tweens['app-second-fourth'].to
        .append TweenMax.to __tweens['app-second-fifth'].target, __tweens['app-second-fifth'].duration, __tweens['app-second-fifth'].to
    ...
    __appThirdRotationTimeline
        .append TweenMax.to __tweens['app-third-third'].target, __tweens['app-third-third'].duration, __tweens['app-third-third'].to
        .append TweenMax.to __tweens['app-third-fourth'].target, __tweens['app-third-fourth'].duration, __tweens['app-third-fourth'].to
    ...
    __appTimeline
        ...
        .appendMultiple [
            TweenMax.staggerTo __tweens['app-first-points-first'].target, __tweens['app-first-points-first'].duration, __tweens['app-first-points-first'].to, 0.1
            TweenMax.staggerTo __tweens['app-first-points-second'].target, __tweens['app-first-points-second'].duration, __tweens['app-first-points-second'].to, 0.1
        ]
        .append __appSecondRotationTimeline
        .appendMultiple [
            TweenMax.staggerTo __tweens['app-second-points-first'].target, __tweens['app-second-points-first'].duration, __tweens['app-second-points-first'].to, 0.1
            TweenMax.staggerTo __tweens['app-second-points-second'].target, __tweens['app-second-points-second'].duration, __tweens['app-second-points-second'].to, 0.1
        ]
    ...
    __timeline
        ...
        .appendMultiple [
            ...
            TweenMax.to __tweens['screen-laptop-graph-first'].target, __tweens['screen-laptop-graph-first'].duration, __tweens['screen-laptop-graph-first'].to
            TweenMax.to __tweens['screen-tablet-first'].target, __tweens['screen-tablet-first'].duration, __tweens['screen-tablet-first'].to
            TweenMax.to __tweens['screen-smartphone-first'].target, __tweens['screen-smartphone-first'].duration, __tweens['screen-smartphone-first'].to
            TweenMax.to __tweens['text-1-first-line-from-right-first'].target, __tweens['text-1-first-line-from-right-first'].duration, __tweens['text-1-first-line-from-right-first'].to
            TweenMax.to __tweens['text-1-second-line-from-right-first'].target, __tweens['text-1-second-line-from-right-first'].duration, __tweens['text-1-second-line-from-right-first'].to
            TweenMax.to __tweens['text-1-third-line-from-right-first'].target, __tweens['text-1-third-line-from-right-first'].duration, __tweens['text-1-third-line-from-right-first'].to
            TweenMax.to __tweens['text-1-third-line-from-right-first'].target, __tweens['text-1-third-line-from-right-first'].duration, __tweens['text-1-third-line-from-right-first'].to
            TweenMax.to __tweens['table-first-first'].target, __tweens['table-first-first'].duration, __tweens['table-first-first'].to
            TweenMax.to __tweens['table-second-first'].target, __tweens['table-second-first'].duration, __tweens['table-second-first'].to
            TweenMax.to __tweens['table-third-first'].target, __tweens['table-third-first'].duration, __tweens['table-third-first'].to
            TweenMax.to __tweens['horizontal-points-first'].target, __tweens['horizontal-points-first'].duration, __tweens['horizontal-points-first'].to
            TweenMax.to __tweens['table-first-points-first'].target, __tweens['table-first-points-first'].duration, __tweens['table-first-points-first'].to
            TweenMax.to __tweens['table-second-points-first'].target, __tweens['table-second-points-first'].duration, __tweens['table-second-points-first'].to
            TweenMax.to __tweens['table-third-points-first'].target, __tweens['table-third-points-first'].duration, __tweens['table-third-points-first'].to
            TweenMax.to __tweens['app-first-first'].target, __tweens['app-first-first'].duration, __tweens['app-first-first'].to
            TweenMax.to __tweens['app-second-first'].target, __tweens['app-second-first'].duration, __tweens['app-second-first'].to
            TweenMax.to __tweens['app-third-first'].target, __tweens['app-third-first'].duration, __tweens['app-third-first'].to
            TweenMax.to __tweens['silhouettes-first-first'].target, __tweens['silhouettes-first-first'].duration, __tweens['silhouettes-first-first'].to
            TweenMax.to __tweens['silhouettes-second-first'].target, __tweens['silhouettes-second-first'].duration, __tweens['silhouettes-second-first'].to
            TweenMax.to __tweens['silhouettes-third-first'].target, __tweens['silhouettes-third-first'].duration, __tweens['silhouettes-third-first'].to
            TweenMax.to __tweens['text-3-first-line-from-right-first'].target, __tweens['text-3-first-line-from-right-first'].duration, __tweens['text-3-first-line-from-right-first'].to
            TweenMax.to __tweens['text-3-second-line-from-right-first'].target, __tweens['text-3-second-line-from-right-first'].duration, __tweens['text-3-second-line-from-right-first'].to
        ...
        .appendMultiple [
            TweenMax.to __tweens['laptop-second'].target, __tweens['laptop-second'].duration, __tweens['laptop-second'].to
            TweenMax.to __tweens['tablet-second'].target, __tweens['tablet-second'].duration, __tweens['tablet-second'].to
            TweenMax.to __tweens['smartphone-second'].target, __tweens['smartphone-second'].duration, __tweens['smartphone-second'].to
        ]
        .appendMultiple [
            TweenMax.to __tweens['screen-laptop-second'].target, __tweens['screen-laptop-second'].duration, __tweens['screen-laptop-second'].to
            TweenMax.to __tweens['screen-tablet-second'].target, __tweens['screen-tablet-second'].duration, __tweens['screen-tablet-second'].to
            TweenMax.to __tweens['screen-smartphone-second'].target, __tweens['screen-smartphone-second'].duration, __tweens['screen-smartphone-second'].to
        ]
        ...
        .appendMultiple [
            ...
            TweenMax.to __tweens['text-1-second-line-from-right-third'].target, __tweens['text-1-second-line-from-right-third'].duration, __tweens['text-1-second-line-from-right-third'].to
            TweenMax.to __tweens['text-1-third-line-from-right-third'].target, __tweens['text-1-third-line-from-right-third'].duration, __tweens['text-1-third-line-from-right-third'].to
        ]
        .append TweenMax.to __tweens['screen-laptop-2-second'].target, __tweens['screen-laptop-2-second'].duration, __tweens['screen-laptop-2-second'].to
        .append TweenMax.to __tweens['table-first-second'].target, __tweens['table-first-second'].duration, __tweens['table-first-second'].to
        .append TweenMax.to __tweens['table-second-second'].target, __tweens['table-second-second'].duration, __tweens['table-second-second'].to
        .append TweenMax.to __tweens['table-third-second'].target, __tweens['table-third-second'].duration, __tweens['table-third-second'].to
        .append TweenMax.staggerTo __tweens['horizontal-points-second'].target, __tweens['horizontal-points-second'].duration, __tweens['horizontal-points-second'].to, 0.03
        .append TweenMax.staggerTo __tweens['table-first-points-second'].target, __tweens['table-first-points-second'].duration, __tweens['table-first-points-second'].to, 0.03
        .append TweenMax.staggerTo __tweens['table-second-points-second'].target, __tweens['table-second-points-second'].duration, __tweens['table-second-points-second'].to, 0.03
        .append TweenMax.staggerTo __tweens['table-third-points-second'].target, __tweens['table-third-points-second'].duration, __tweens['table-third-points-second'].to, 0.03
        .appendMultiple [
            TweenMax.to __tweens['app-first-second'].target, __tweens['app-first-second'].duration, __tweens['app-first-second'].to
        ...
        .append TweenMax.to __tweens['text-3-first-line-from-right-second'].target, __tweens['text-3-first-line-from-right-second'].duration, __tweens['text-3-first-line-from-right-second'].to
        .append TweenMax.to __tweens['text-3-second-line-from-right-second'].target, __tweens['text-3-second-line-from-right-second'].duration, __tweens['text-3-second-line-from-right-second'].to
        .append TweenMax.to __tweens['text-3-third-line-from-right-second'].target, __tweens['text-3-third-line-from-right-second'].duration, __tweens['text-3-third-line-from-right-second'].to
        .appendMultiple [
            __appTimeline
            TweenMax.to __tweens['screen-laptop-2-third'].target, __tweens['screen-laptop-2-third'].duration, __tweens['screen-laptop-2-third'].to
